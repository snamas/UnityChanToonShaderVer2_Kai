...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilOut/SHADOWCASTER"
    }
