...
Shader "UnityChanToonShader_kai/Tessellation/Light/Toon_DoubleShadeWithFeather" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_DoubleShadeWithFeather/OUTLINE"
