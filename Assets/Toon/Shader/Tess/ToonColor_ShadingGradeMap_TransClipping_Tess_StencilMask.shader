...
Shader "UnityChanToonShader_kai/Tessellation/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_TransClipping_StencilMask/SHADOWCASTER"
    }
