...
Shader "UnityChanToonShader_kai/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/FORWARD"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/SHADOWCASTER"
