...
Shader "UnityChanToonShader_kai/Tessellation/Light/AngelRing/Toon_ShadingGradeMap" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/AngelRing/Toon_ShadingGradeMap/OUTLINE"
