...
Shader "UnityChanToonShader_kai/Tessellation/Light/Toon_ShadingGradeMap_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_StencilMask/OUTLINE"
