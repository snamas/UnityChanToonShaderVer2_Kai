...
Shader "UnityChanToonShader_kai/Tessellation/Light/Toon_ShadingGradeMap_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_StencilOut/OUTLINE"
