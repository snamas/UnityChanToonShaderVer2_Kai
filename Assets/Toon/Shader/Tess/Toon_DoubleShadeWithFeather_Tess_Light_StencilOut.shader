...
Shader "UnityChanToonShader_kai/Tessellation/Light/Toon_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/OUTLINE"
