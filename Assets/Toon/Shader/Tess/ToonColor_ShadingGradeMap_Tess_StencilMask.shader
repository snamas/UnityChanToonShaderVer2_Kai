...
Shader "UnityChanToonShader_kai/Tessellation/NoOutline/ToonColor_ShadingGradeMap_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_StencilMask/FORWARD"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Tessellation/Toon_ShadingGradeMap_StencilMask/SHADOWCASTER"
