...
Shader "UnityChanToonShader_kai/NoOutline/AngelRing/ToonColor_ShadingGradeMap_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/AngelRing/Toon_ShadingGradeMap_StencilOut/FORWARD_DELTA"
