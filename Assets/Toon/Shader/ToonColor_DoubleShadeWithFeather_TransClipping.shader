...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_DoubleShadeWithFeather_TransClipping" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_TransClipping/FORWARD_DELTA"
