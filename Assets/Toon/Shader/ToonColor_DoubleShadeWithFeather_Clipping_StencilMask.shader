...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD"
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_Clipping_StencilMask/SHADOWCASTER"
    }
