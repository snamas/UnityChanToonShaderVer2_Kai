...
Shader "UnityChanToonShader_kai/Mobile/Toon_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_StencilOut/OUTLINE"
