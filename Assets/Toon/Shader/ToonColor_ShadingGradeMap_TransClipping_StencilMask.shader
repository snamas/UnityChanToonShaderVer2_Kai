...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD_DELTA"
