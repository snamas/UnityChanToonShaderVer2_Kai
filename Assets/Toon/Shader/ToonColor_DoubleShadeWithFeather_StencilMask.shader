...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_DoubleShadeWithFeather_StencilMask/FORWARD_DELTA"
