...
Shader "UnityChanToonShader_kai/NoOutline/ToonColor_ShadingGradeMap_TransClipping" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader_kai/Toon_ShadingGradeMap_TransClipping/FORWARD"
        UsePass "UnityChanToonShader_kai/Toon_ShadingGradeMap_TransClipping/FORWARD_DELTA"
        UsePass "UnityChanToonShader_kai/Toon_ShadingGradeMap_TransClipping/SHADOWCASTER"
    }
